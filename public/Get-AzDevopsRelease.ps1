    ...
    process {
        $ReleaseId | ForEach-Object {
            ...
            if ($_) {
                ...
                if ($SourceBranchFilter) { Write-Warning -Message "Can't use SourceBranchFilter in combination with ID. Ignoring." }
                if ($ArtifactVersionId) { Write-Warning -Message "Can't use ArtifactVersionId in combination with ID. Ignoring." }
                if ($SourceId) { Write-Warning -Message "Can't use SourceId in combination with ID. Ignoring." }
                if ($ArtifactTypeId) { Write-Warning -Message "Can't use ArtifactTypeId in combination with ID. Ignoring." }
                if ($ReleaseExpand) { Write-Warning -Message "Can't use ReleaseExpand in combination with ID use Expand instead! Ignoring." }
                ...
                if ($MaxCreatedTime) { Write-Warning -Message "Can't use MaxCreatedTime in combination with ID. Ignoring." }
                if ($MinCreatedTime) { Write-Warning -Message "Can't use MinCreatedTime in combination with ID. Ignoring." }
                if ($EnvironmentStatusFilter) { Write-Warning -Message "Can't use EnvironmentStatusFilter in combination with ID. Ignoring." }
                if ($StatusFilter) { Write-Warning -Message "Can't use StatusFilter in combination with ID. Ignoring." }
                if ($CreatedBy) { Write-Warning -Message "Can't use CreatedBy in combination with ID. Ignoring." }
                if ($SearchText) { Write-Warning -Message "Can't use SearchText in combination with ID. Ignoring." }
